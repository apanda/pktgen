...
static const ProtobufCFieldDescriptor request__field_descriptors[1] = {
    {
     ...
     offsetof(Request, n_jobs), offsetof(Request, jobs), &job__descriptor, NULL,
     0,            /* flags */
     0, NULL, NULL /* reserved1,reserved2, etc */
    },
};
...
const ProtobufCMessageDescriptor request__descriptor = {
    PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC, "Request", "Request", "Request", "",
    sizeof(Request), 1, request__field_descriptors,
    request__field_indices_by_name, 1, request__number_ranges,
    (ProtobufCMessageInit)request__init, NULL, NULL, NULL /* reserved[123] */
};
